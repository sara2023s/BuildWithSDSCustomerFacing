...
const AboutPage: React.FC<{ onNavigate: (page: string) => void }> = ({ onNavigate }) => {
  return (
    <div className="pt-24 md:pt-32 pb-16 md:pb-24 container mx-auto px-4 md:px-6 min-h-screen flex flex-col items-center">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-800 border border-gray-700 text-green-vibrant text-xs font-bold uppercase tracking-wider mb-4 md:mb-6">
          <Code2 className="w-3 h-3" />
          Who We Are
        </div>
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 md:mb-6 px-4">
          More than just <br className="hidden sm:block" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-green-vibrant drop-shadow-sm">Code & Pixels.</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-24 w-full max-w-6xl">
        ...
        <motion.div 
          ...
          className="bg-gray-800 border border-gray-700 rounded-3xl p-6 md:p-8 lg:p-12 relative overflow-hidden shadow-sm"
        >
           <div className="absolute top-0 right-0 w-64 h-64 bg-purple-purple/10 blur-[80px] rounded-full pointer-events-none"></div>
           
           <h3 className="text-2xl font-bold text-white mb-6">The Founder's Vision</h3>
           ...
           <div className="flex flex-col sm:flex-row gap-4">
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gray-800 text-white font-bold hover:bg-gray-800 transition-colors"
              >
        ...
        >
          <div className="bg-gray-800 border border-gray-700 p-6 rounded-2xl hover:border-green-vibrant/30 transition-colors shadow-sm">
            <div className="w-10 h-10 rounded-lg bg-green-vibrant/10 text-green-vibrant flex items-center justify-center mb-4">
              <Globe className="w-5 h-5" />
            </div>
            <h4 className="font-bold text-white mb-2">Global Standards</h4>
            <p className="text-xs text-gray-400">We adhere to the strict web standards used by top tech companies.</p>
          </div>
          ...
          <div className="bg-gray-800 border border-gray-700 p-6 rounded-2xl hover:border-green-vibrant/30 transition-colors shadow-sm">
            ...
            <h4 className="font-bold text-white mb-2">Lighting Fast</h4>
            <p className="text-xs text-gray-400">Sub-second load times ensure you never lose a customer to lag.</p>
          </div>
          ...
          <div className="bg-gray-800 border border-gray-700 p-6 rounded-2xl hover:border-green-vibrant/30 transition-colors shadow-sm">
            ...
            <p className="text-xs text-gray-400">No bloated builders. Just pure, efficient, hand-crafted code.</p>
          </div>
          ...
          <div className="bg-gray-800 border border-gray-700 p-6 rounded-2xl hover:border-green-vibrant/30 transition-colors shadow-sm">
            ...
            <p className="text-xs text-gray-400">Ready to handle traffic spikes as your business grows.</p>
          </div>
        </motion.div>
      </div>
      ...
      >
        <div className="relative bg-gradient-to-r from-purple/10 to-purple/5 border border-purple/20 rounded-3xl p-6 md:p-8 lg:p-12 backdrop-blur-sm bg-gray-800/50">
          <div className="absolute inset-0 bg-gradient-to-r from-purple/5 to-purple/3 rounded-3xl"></div>
          <div className="relative z-10">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to work with us?</h2>
            <p className="text-gray-300 mb-8 max-w-xl mx-auto">Let's turn your vision into a high-performance reality. Book a discovery call today.</p>
