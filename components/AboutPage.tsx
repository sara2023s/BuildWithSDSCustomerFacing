  ...
  return (
    <div className="pt-24 md:pt-32 pb-16 md:pb-24 container mx-auto px-4 md:px-6 min-h-screen flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-24 w-full max-w-6xl">
        ...
        >
           ...
           <div className="flex flex-col sm:flex-row gap-4">
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white text-brand-navy font-bold hover:bg-slate-200 transition-colors"
              >
        ...
        >
          <div className="bg-brand-navy border border-white/5 p-6 rounded-2xl hover:border-brand-purple/30 transition-colors">
            ...
            <p className="text-xs text-slate-500">We adhere to the strict web standards used by top tech companies.</p>
          </div>
          ...
          <div className="bg-brand-navy border border-white/5 p-6 rounded-2xl hover:border-brand-purple/30 transition-colors">
            ...
            <p className="text-xs text-slate-500">Sub-second load times ensure you never lose a customer to lag.</p>
          </div>
          ...
          <div className="bg-brand-navy border border-white/5 p-6 rounded-2xl hover:border-brand-purple/30 transition-colors">
            ...
            <p className="text-xs text-slate-500">No bloated builders. Just pure, efficient, hand-crafted code.</p>
          </div>
          ...
          <div className="bg-brand-navy border border-white/5 p-6 rounded-2xl hover:border-brand-purple/30 transition-colors">
            ...
            <p className="text-xs text-slate-500">Ready to handle traffic spikes as your business grows.</p>
          </div>
        </motion.div>
      </div>
      ...
      >
        <div className="relative bg-gradient-to-r from-brand-purple/20 to-brand-navy/20 border border-brand-purple/20 rounded-3xl p-6 md:p-8 lg:p-12 backdrop-blur-sm">
          ...
          <div className="relative z-10">
            ...
            <p className="text-violet-100 mb-8 max-w-xl mx-auto">Let's turn your vision into a high-performance reality. Book a discovery call today.</p>
