  ...
  return (
    <div className="pt-24 md:pt-32 pb-16 md:pb-24 container mx-auto px-4 md:px-6 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-vibrant/10 border border-green-vibrant/20 text-green-vibrant text-xs font-bold uppercase tracking-wider mb-4">
            <Filter className="w-3 h-3" />
            Our Work
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold">Client <span className="text-gray-400">Showcase</span></h1>
        </motion.div>
              ...
              <SpotlightCard className="h-full group cursor-pointer">
                ...
                <div className="p-6 md:p-8 relative">
                   <div className="flex justify-between items-start mb-4">
                     <div>
                       <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-green-vibrant transition-colors">{project.title}</h3>
                       <div className="flex flex-wrap gap-2 mb-4">
                          {project.tags.map(t => (
                            <span key={t} className="text-xs font-mono text-gray-400 bg-gray-800/50 px-2 py-1 rounded border border-gray-700">
                              {t}
                            </span>
                          ))}
                       </div>
                     </div>
                     <div className="p-3 rounded-full bg-gray-800/50 text-gray-300 group-hover:bg-green-vibrant group-hover:text-white transition-all transform group-hover:-translate-y-1 group-hover:translate-x-1">
      ...
      <div className="mt-20 text-center">
        <div className="inline-block p-8 rounded-3xl bg-gradient-to-br from-gray-900 to-transparent border border-gray-800 max-w-2xl mx-auto shadow-sm">
          <h3 className="text-2xl font-bold text-white mb-4">Ready to start your project?</h3>
          <p className="text-gray-300 mb-8">We treat every project as a portfolio piece. Let's build something award-winning together.</p>
