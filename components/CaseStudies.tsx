...
const CaseStudies: React.FC = () => {
  return (
    <section id="work" className="py-24 container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end">
              <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                ...
                <button className="w-full py-3 rounded-xl bg-white text-brand-navy font-bold opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-4 group-hover:translate-y-0 delay-100 hover:bg-violet-50 hover:scale-[1.02]">
                  View Project
                </button>
              </div>
            </div>
