...
const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-purple/10 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
          x: [0, 50, 0],
      ...
      />
      <motion.div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-brand-purple/8 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.15, 1],
          opacity: [0.2, 0.4, 0.2],
          x: [0, -40, 0],
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20 flex-1 flex flex-col items-center justify-center">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-navy_light/80 border border-white/10 backdrop-blur-md mb-8 hover:border-brand-purple/50 transition-all cursor-default shadow-lg shadow-black/20 hover:shadow-brand-purple/20"
        >
          <motion.span 
          ...
          <span className="text-xs md:text-sm font-medium text-slate-300">Accepting new clients • <span className="text-white font-bold">Live in &lt; 7 Days</span></span>
        </motion.div>
        ...
        >
          ...
          <motion.span 
            ...
            className="block mt-2 bg-clip-text text-transparent bg-gradient-to-r from-white via-brand-purple to-white animate-gradient-x pb-4 cursor-default"
          >
            Digital Presence.
          </motion.span>
          <motion.span
            ...
            className="block text-xl md:text-3xl font-semibold text-slate-300 mt-4"
          >
        ...
        >
          <motion.div 
            className="w-64 h-auto border border-white/10 rounded-xl bg-brand-navy_light/50 backdrop-blur-sm rotate-[-6deg] p-4 shadow-2xl shadow-brand-purple/5 pointer-events-auto"
          ...
          >
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                      <div className="w-8 h-8 rounded-full bg-brand-purple/30 border border-brand-purple/20 flex items-center justify-center">
        ...
        >
          <motion.div 
            className="w-48 h-48 border border-white/10 rounded-2xl bg-brand-navy_light/50 backdrop-blur-sm rotate-[12deg] flex items-center justify-center p-4 shadow-2xl shadow-brand-purple/5 group pointer-events-auto"
            whileHover={{ rotate: 0, scale: 1.05, y: -5 }}
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
          >
              <div className="text-center">
                <Clock className="w-8 h-8 text-brand-purple mx-auto mb-2" />
                <div className="text-4xl font-bold text-slate-800 group-hover:text-brand-purple/40 transition-colors">
                  &lt; 7<span className="text-2xl"> Days</span>
                </div>
                <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">Turnaround</div>
              </div>
          </motion.div>
        </motion.div>
