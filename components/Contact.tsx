...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 container mx-auto px-4 md:px-6 relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start relative z-10">
        ...
        >
          ...
          <div className="space-y-6">
            <a href="mailto:hello@buildwithsds.com" className="flex items-center gap-4 group cursor-pointer p-4 rounded-2xl hover:bg-white/5 transition-all">
              ...
              <div>
                ...
                <p className="text-white font-medium text-lg group-hover:text-brand-purple transition-colors">hello@buildwithsds.com</p>
              </div>
            </a>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-brand-navy_light/40 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl relative"
        >
          {/* Form Glow */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input 
                ...
                className="w-full bg-brand-navy/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-purple focus:ring-1 focus:ring-brand-purple transition-all placeholder:text-slate-600"
