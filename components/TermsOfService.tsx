      ...
      >
        ...
        <div className="mb-8 md:mb-12">
          <button
            ...
            className="inline-flex items-center gap-2 text-gray-300 hover:text-white transition-colors mb-6 md:mb-8 group min-h-[44px] px-2"
          >
          ...
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-green-vibrant/10 border border-green-vibrant/20 flex items-center justify-center flex-shrink-0">
              <FileText className="w-5 h-5 md:w-6 md:h-6 text-green-vibrant" />
            </div>
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">Terms of Service</h1>
              <p className="text-gray-300 text-sm md:text-base">Last updated: January 2025</p>
            </div>
          </div>
        </div>

        {/* Content */}
        <div className="bg-gray-900 border border-gray-800 rounded-3xl p-6 md:p-8 lg:p-12 space-y-6 md:space-y-8 shadow-sm">
          
          <div>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4">1. Agreement to Terms</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-4">3. Service Plans and Pricing</h2>
            <div className="space-y-4 text-gray-200">
              ...
              <div className="p-4 bg-gray-800 border border-gray-800 rounded-xl">
                <p className="text-white font-semibold mb-2">Payment Terms:</p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-4">4. Project Timeline and Deliverables</h2>
            <p className="text-gray-200 leading-relaxed mb-3">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-200">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">6.1 Client Content</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">6.3 Third-Party Components</h3>
                <p className="leading-relaxed">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-200">
              ...
              <div className="p-4 bg-gray-800 border border-gray-800 rounded-xl">
                <p className="text-white font-semibold mb-2">Refund Policy:</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-4">11. Modifications to Services</h2>
            <p className="text-gray-200 leading-relaxed">
          ...
          <div>
            ...
            <div className="p-4 bg-gray-800 border border-gray-800 rounded-xl">
              ...
              <p className="text-gray-200">Email: hello@buildwithsds.com</p>
            </div>
          </div>
